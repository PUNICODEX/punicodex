...
// ========== BOOKING SYSTEM ==========
const API_BASE = window.HELIOS_API_BASE || 'http://localhost:3456'; // Set window.HELIOS_API_BASE in HTML for production
...
function openModal(slotId) {
  console.log('[PUNYCODEX:helios] openModal called:', slotId);
  try {
    ...
    if (!slot) {
      ...
      if (!slotEl) { console.log('[PUNYCODEX:helios] No slotEl found'); return; }
    ...
    console.log('[PUNYCODEX:helios] Modal opened for slot', slotId);
  } catch (err) {
    console.error('[PUNYCODEX:helios] openModal error:', err);
  }
}
...
document.addEventListener('click', (e) => {
  ...
  console.log('[PUNYCODEX:helios] Slot clicked:', slotId);
  openModal(slotId);
});
