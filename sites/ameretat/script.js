...
async function loadSlots() {
  try {
    const res = await fetch(`${API_BASE}/api/slots/?site=ameretat`);
...
async function validateDiscountCode() {
  ...
  try {
    const payload = { code, temple: 'ameretat', leaseMonths: currentLeaseMonths };
...
(function initPatronSystem() {
  ...
  const templeId = 'ameretat';
  const siteName = 'Amərətāt';
