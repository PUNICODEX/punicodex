...
function openModal(slotId) {
  console.log('[PUNYCODEX:demeter] openModal called:', slotId);
  try {
    ...
    if (!slot) {
      ...
      if (!slotEl) { console.log('[PUNYCODEX:demeter] No slotEl found'); return; }
    ...
    console.log('[PUNYCODEX:demeter] Modal opened for slot', slotId);
  } catch (err) {
    console.error('[PUNYCODEX:demeter] openModal error:', err);
  }
}
...
document.addEventListener('click', (e) => {
  ...
  console.log('[PUNYCODEX:demeter] Slot clicked:', slotId);
  openModal(slotId);
});
