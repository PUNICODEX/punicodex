...
SITES = {
    ...
    'asia': {
        ...
        'unicode': 'Asíā',
        'ascii': 'Asia',
        'punycode': 'xn--as-xka77a.com',
        'tagline': 'The Rising East',
        'description': 'The authentic digital shrine to Asíā, the personified continent of Asia in Greek mythology. Daughter of Oceanus, namesake of the vast eastern lands.',
        'og_desc': 'Explore Asíā — the personified continent of Asia in Greek mythology.',
        'pronunciation': '/a.sí.aː/',
        'pronunciation_note': 'Classical Greek: a-SEE-aa (acute on iota, long alpha)',
        'etymology': 'From Greek Ἀσία (Asíā), of uncertain origin. Possibly from Assuwa, a Luwian name for a region in western Anatolia, or from the Hittite name for the eastern lands. The Greeks applied it first to Anatolia, then to the entire continent east of the Hellespont.',
        'mythology': 'Asíā is the personification of the Asian continent in Greek mythology, a daughter of Oceanus and Tethys. Her name first designated the lands of Anatolia — the "Rising Sun" territories across the Hellespont — before expanding to encompass the vast eastern world from the Bosphorus to the farthest reaches known to the Greeks. As the wife of Prometheus (in some traditions) or Iapetus, she embodies the eastern origin of many cultural gifts that reached Greece: metallurgy, writing, and the arts of civilization.',
