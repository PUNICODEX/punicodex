...
const MANUAL_CORRECTIONS = {
  'Aphrodite_Met_1991.11.jpg': 'Marble statuette of Aphrodite Anadyomene (rising) type MET 146990.jpg',
};
...
async function run() {
  ...
  for (const [oldFilename, correctFilename] of entries) {
    ...
    // Match either /thumb/{h1}/{h2}/{filename}/ or /commons/{h1}/{h2}/{filename}
