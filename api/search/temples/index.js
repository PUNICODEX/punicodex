...
const { classifyTerm } = require('../../../platform/api/homograph-service');
...
function ensureCorpus() {
  ...
  try {
    ...
    const { migrate } = require('../../../platform/db/migrate-temple-content');
    const db = getDb();
    migrate(db);
    ...
    if (c === 0) {
      ...
      const { seedTempleContent } = require('../../../platform/db/seed-temple-content');
