...
| instructions.jsonl | 8,547 | 3.83 MB | Scholarly question/answer pairs (Phase 1). |
| instructions-train.jsonl | 40,894 | 24.58 MB | Training split (80%) of scholarly + safety examples. |
...
| dialogue-examples.jsonl | 3,207 | 2.21 MB | Multi-turn conversation examples (Phase 3). |
...
| preference-examples.jsonl | 3,745 | 2.05 MB | Chosen/rejected pairs for RLHF (Phase 6). |
...
| chat-train.jsonl | 58,706 | 79.57 MB | Unified chat-format training corpus, 80% deterministic split (Phase 14). |
| chat-eval.jsonl | 14,650 | 19.85 MB | Held-out chat-format evaluation split, 20% (Phase 14). |
