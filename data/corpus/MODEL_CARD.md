...
| Split | Examples | File |
|-------|----------|------|
| Train | 58,100 | `data/corpus/chat-train.jsonl` |
| Evaluation | 14,534 | `data/corpus/chat-eval.jsonl` |
| **Total** | **72,634** | — |

Source corpora:
- `instructions.jsonl`: 8,424 examples
- `safety-examples.jsonl`: 42,342 examples
- `dialogue-examples.jsonl`: 3,148 examples
- `tool-use-examples.jsonl`: 4,575 examples
- `multimodal-examples.jsonl`: 1,843 examples
- `preference-examples.jsonl`: 3,703 examples
- `reasoning-examples.jsonl`: 3,569 examples
- `mythology-synthesis.jsonl`: 391 examples
- `oracle-examples.jsonl`: 1,906 examples
...
- `data/corpus/pretrain.jsonl` — 5,464 training documents (484,625 whitespace tokens).
- `data/corpus/pretrain-validation.jsonl` — 293 validation documents (25,255 whitespace tokens).
