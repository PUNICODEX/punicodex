...
| Split | Examples | File |
|-------|----------|------|
| Train | 58,065 | `data/corpus/chat-train.jsonl` |
| Evaluation | 14,559 | `data/corpus/chat-eval.jsonl` |
| **Total** | **72,624** | — |

Source corpora:
- `instructions.jsonl`: 8,422 examples
- `safety-examples.jsonl`: 42,342 examples
- `dialogue-examples.jsonl`: 3,146 examples
- `tool-use-examples.jsonl`: 4,575 examples
- `multimodal-examples.jsonl`: 1,839 examples
- `preference-examples.jsonl`: 3,703 examples
- `reasoning-examples.jsonl`: 3,569 examples
- `mythology-synthesis.jsonl`: 391 examples
- `oracle-examples.jsonl`: 1,904 examples
...
- `data/corpus/pretrain.jsonl` — 5,460 training documents (482,921 whitespace tokens).
- `data/corpus/pretrain-validation.jsonl` — 295 validation documents (25,403 whitespace tokens).
