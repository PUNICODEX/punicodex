...
| Split | Examples | File |
|-------|----------|------|
| Train | 58,649 | `data/corpus/chat-train.jsonl` |
| Evaluation | 14,738 | `data/corpus/chat-eval.jsonl` |
| **Total** | **73,387** | — |

Source corpora:
- `instructions.jsonl`: 8,540 examples
- `safety-examples.jsonl`: 42,693 examples
- `dialogue-examples.jsonl`: 3,212 examples
- `tool-use-examples.jsonl`: 4,620 examples
- `multimodal-examples.jsonl`: 1,913 examples
- `preference-examples.jsonl`: 3,743 examples
- `reasoning-examples.jsonl`: 3,602 examples
...
- `data/corpus/pretrain.jsonl` — 5,524 training documents (518,941 whitespace tokens).
- `data/corpus/pretrain-validation.jsonl` — 296 validation documents (26,902 whitespace tokens).
