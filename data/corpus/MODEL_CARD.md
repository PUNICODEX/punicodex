...
| Split | Examples | File |
|-------|----------|------|
| Train | 58,517 | `data/corpus/chat-train.jsonl` |
| Evaluation | 14,716 | `data/corpus/chat-eval.jsonl` |
| **Total** | **73,233** | — |

Source corpora:
- `instructions.jsonl`: 8,516 examples
- `safety-examples.jsonl`: 42,617 examples
- `dialogue-examples.jsonl`: 3,200 examples
- `tool-use-examples.jsonl`: 4,610 examples
- `multimodal-examples.jsonl`: 1,902 examples
- `preference-examples.jsonl`: 3,734 examples
- `reasoning-examples.jsonl`: 3,594 examples
...
- `data/corpus/pretrain.jsonl` — 5,514 training documents (514,243 whitespace tokens).
- `data/corpus/pretrain-validation.jsonl` — 297 validation documents (25,706 whitespace tokens).
