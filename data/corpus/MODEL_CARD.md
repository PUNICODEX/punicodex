...
| Split | Examples | File |
|-------|----------|------|
| Train | 58,821 | `data/corpus/chat-train.jsonl` |
| Evaluation | 14,624 | `data/corpus/chat-eval.jsonl` |
| **Total** | **73,445** | — |

Source corpora:
- `instructions.jsonl`: 8,557 examples
- `safety-examples.jsonl`: 42,706 examples
- `dialogue-examples.jsonl`: 3,211 examples
- `tool-use-examples.jsonl`: 4,635 examples
- `multimodal-examples.jsonl`: 1,911 examples
- `preference-examples.jsonl`: 3,749 examples
...
- `data/corpus/pretrain.jsonl` — 5,518 training documents (514,781 whitespace tokens).
- `data/corpus/pretrain-validation.jsonl` — 299 validation documents (25,847 whitespace tokens).
