...
| Split | Examples | File |
|-------|----------|------|
| Train | 56,463 | `data/corpus/chat-train.jsonl` |
| Evaluation | 14,239 | `data/corpus/chat-eval.jsonl` |
| **Total** | **70,702** | — |

Source corpora:
- `instructions.jsonl`: 8,131 examples
- `safety-examples.jsonl`: 41,441 examples
- `dialogue-examples.jsonl`: 2,972 examples
- `tool-use-examples.jsonl`: 4,470 examples
- `multimodal-examples.jsonl`: 1,707 examples
- `preference-examples.jsonl`: 3,615 examples
...
- `data/corpus/pretrain.jsonl` — 5,248 training documents (396,780 whitespace tokens).
- `data/corpus/pretrain-validation.jsonl` — 272 validation documents (21,987 whitespace tokens).
