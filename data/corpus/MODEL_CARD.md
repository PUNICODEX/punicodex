...
**Data version:** 2.0.55  
**Generated:** 2026-07-14T13:30:24.582Z  
...
| Split | Examples | File |
|-------|----------|------|
| Train | 56,466 | `data/corpus/chat-train.jsonl` |
| Evaluation | 14,233 | `data/corpus/chat-eval.jsonl` |
| **Total** | **70,699** | — |

Source corpora:
- `instructions.jsonl`: 8,130 examples
- `safety-examples.jsonl`: 41,441 examples
- `dialogue-examples.jsonl`: 2,971 examples
...
- `data/corpus/pretrain.jsonl` — 5,248 training documents (396,767 whitespace tokens).
