...
test('(b) representative pages carry the cluster and the kit OG image', () => {
  ...
  // index.html: og:image + twitter:image (kit card); flagship template: the
  // per-temple OG card convention (assets/og/{id}.jpg, generated by
  ...
  assert.ok(read('templates/flagship/index.html').includes('/assets/og/{{TEMPLE_ID}}.jpg'));
});
