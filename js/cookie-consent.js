...
(function () {
  ...
  panel.innerHTML =
    ...
    '<p class="pc-cookie__text">PuniCodex stores only strictly-necessary items on your device — your consent record, interface preferences, and first-party, privacy-preserving analytics. No third-party trackers, no advertising cookies, no fingerprinting. Details live in the <a href="/privacy/">Privacy Policy</a>.</p>' +
